...
\begin{defn}\label{def:Filb}
    ...
    \end{equation*}
    spanned by functors $F$ such that $\lim_p F_p = \zr$. We define the \textbf{bounded below filtered objects} to be the full subcategory
    \begin{equation*}
...
\end{equation}
which give us a formula for the $p$-th piece of $\cI K$:
\[
    (\cI K)_p \simeq \Map(\bbS^{-p}_p, K).
\]
