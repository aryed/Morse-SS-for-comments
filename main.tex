...
\section{Models for chain complexes}
Befor we moving on to the geometric parts of the paper, we give another useful description for composition of chain complexes maps.
The goal is to give a description for the diffrential, in a topologically enriched model for chain complexes.
